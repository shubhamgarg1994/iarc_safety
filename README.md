...
This repository contains a node monitoring system which keeps track of heartbeats for all critical nodes in the system, allows for communication of failure states, and mediates safe responses to failures in various components of the system.
